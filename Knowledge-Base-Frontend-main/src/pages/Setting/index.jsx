      ...
      >
        <form onSubmit={formSubmitHandler}>
          <main className={"flex flex-col gap-8"}>
            ...
            >
              <div className="w-[60%] RangeForPhone:flex RangeForPhone:flex-row RangeForPhone:justify-center RangeForPhone:gap-8 RangeForPhone:w-[100%] Mobile_L_425:flex-col">
                <div
